...
import PortImage9 from "../assets/react_native.jpg"
import PortImage10 from "../assets/flutter.jpg"
...
// ]
  ...
  return (
    ...
    <div className="  md:pt-40 lg:pt-72 ">
...
className=" shadow-md shadow-purple-500 rounded-lg duration-500 hover:scale-105 py-2 ">
        ...
        <div
className=" shadow-md shadow-blue-900 rounded-lg duration-500 hover:scale-105 py-2 ">
